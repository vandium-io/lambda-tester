    ...
    expectSucceed( resultVerifier ) {
        ...
        let promise = resolveHandler( this )
            .then( ( handler ) => {
                ...
                return new LambdaRunner( States.contextSucceed, resultVerifier, this.options )
    ...
    expectFail( resultVerifier ) {
        ...
        let promise = resolveHandler( this )
            .then( ( handler ) => {
                ...
                return new LambdaRunner( States.contextFail, resultVerifier, this.options )
                        .withEvent( this._event )
                        .withContext( this._context )
                        .run( handler );
    ...
    expectError( resultVerifier ) {
        ...
        let promise = resolveHandler( this )
            .then( ( handler ) => {
                ...
                return new LambdaRunner( States.callbackError, resultVerifier, this.options )
                        .withEvent( this._event )
    ...
    expectResult( resultVerifier ) {
        ...
        let promise = resolveHandler( this )
            .then( ( handler ) => {
                ...
                return new LambdaRunner( States.callbackResult, resultVerifier, this.options )
                        .withEvent( this._event )
                        .withContext( this._context, true )
                        .run( handler );
    ...
    expectReject( resultVerifier ) {
        ...
        let promise = resolveHandler( this )
            .then( ( handler ) => {
                ...
                return new LambdaRunner( States.promiseReject, resultVerifier, this.options )
                        .withEvent( this._event )
                        .withContext( this._context, true )
                        .run( handler );
            });
    ...
    expectResolve( resultVerifier ) {
        ...
        let promise = resolveHandler( this )
            .then( ( handler ) => {
                ...
                return new LambdaRunner( States.promiseResolve, resultVerifier, this.options )
                        .withEvent( this._event )
                        .withContext( this._context, true )
                        .run( handler );
