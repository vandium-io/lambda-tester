...
const MINIMUM_NODE_VERSION = '6.10.1';
const MAXIMUM_NODE_VERSION = '8.10.0';
...
function doVersionCheck() {
    ...
    if( semver.lt(process.versions.node, MINIMUM_NODE_VERSION )) {

        throw new Error( 'Please test with node.js >= ' + MINIMUM_NODE_VERSION );
    }
    else if (  semver.gt(process.versions.node, MAXIMUM_NODE_VERSION ) ) {
