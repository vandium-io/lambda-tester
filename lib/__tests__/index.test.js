...
describe( 'lib/index', function() {
    ...
    describe( 'LambdaTester', function() {
        ...
        describe( '.expectSucceed', function() {
            ...
            it( 'fail: when context.fail() is called, strict', function() {
            ...
            it( 'fail: when verifier fails with .verify, strict', function() {
        ...
        describe( '.expectFail', function() {
            ...
            it( 'fail: when context.succeed() is called, strict', function() {
        ...
        describe( '.expectError', function() {
            ...
            it( 'fail: when context.fail() called, strict', function() {
            ...
            it( 'fail: when context.succeed() called, strict', function() {
